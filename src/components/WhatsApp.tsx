  ...
  return (
    <div className="fixed bottom-24 right-4 z-40 lg:bottom-8 lg:right-8">
      ...
      >
        ...
        <span className="grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-white shadow-[0_8px_22px_-6px_rgba(37,211,102,0.65)] ring-1 ring-black/5 transition-transform duration-300 group-hover:scale-105 group-active:scale-95 lg:h-16 lg:w-16">
          <WhatsAppGlyph className="h-8 w-8 lg:h-9 lg:w-9" />
        </span>
      </a>
    </div>
  );
