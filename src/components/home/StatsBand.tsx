...
const stats = [
  { Icon: Plane, value: "100+", label: "Destination Experts" },
  { Icon: Globe2, value: "10+", label: "Destinations" },
  { Icon: Headset, value: "200+", label: "Different Tours" },
  { Icon: Users, value: "10K+", label: "Trusted Customers" },
];
